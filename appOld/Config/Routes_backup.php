...
$routes->group('api', ['filter' => 'cors'], function ($routes) {
     ...
     $routes->match(['GET', 'options'], "getManagers", "Home::getManagers", ['filter' => 'authFilter']);
     ...
     $routes->match(['GET', 'options'], "getShiftRoaster", "User::getShiftRoaster");
     $routes->match(['POST', 'options'], "createShiftRoaster", "User::createShiftRoaster");
     $routes->match(['GET', 'options'], "getShiftRoasterById/(:num)", "User::getShiftRoasterById/$1");
     $routes->match(['POST', 'options'], "updateShiftRoasterById/(:num)", "User::updateShiftRoasterById/$1");
     $routes->match(['POST', 'options'], "deleteShiftRoasterById/(:num)", "User::deleteShiftRoasterById/$1");
