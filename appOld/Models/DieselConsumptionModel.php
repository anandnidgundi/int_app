...
class DieselConsumptionModel extends Model
{
    ...
    public function getDieselConsumptionAdminList($role, $emp_code, $zone_id, $selectedCluster, $selectedBranch, $selectedMonth, $selectedDate)
    {
