...
class CardioTmtModel extends Model
{
    protected $table = 'cardiologist_tmt'; // Table name
    ...
    public function getCardioTmtData($nid){
    ...
    protected $validationMessages = [
        ...
        public function saveCardioTmtData()
    {
        $CardioTmtModel = new \App\Models\CardioTmtModel();
        ...
        if ($CardioTmtModel->save($data)) {
            return $this->respond(['status' => true, 'message' => 'Data saved successfully.']);
        } else {
            return $this->respond(['status' => false, 'message' => $CardioTmtModel->errors()]);
        }
    }
