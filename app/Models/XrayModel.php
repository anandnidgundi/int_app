...
class XrayModel extends Model
{
    ...
    protected $validationMessages = [
        ...
        public function saveXrayData()
    {
        $XrayModel = new \App\Models\XrayModel();
        ...
        if ($XrayModel->save($data)) {
            return $this->respond(['status' => true, 'message' => 'Data saved successfully.']);
        } else {
            return $this->respond(['status' => false, 'message' => $XrayModel->errors()]);
        }
    }
